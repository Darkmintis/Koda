---
title: Frontend app
desc: Dive into the UI, data namespaces, ClojureScript, React, and worker app functionalities. View Koda's frontend app architecture. Free to try!
---
...
Koda frontend app code resides under <code class="language-text">frontend/src/app</code> path in the main repository.
...
* **components** a library of generic UI widgets, to be used as building blocks
  of koda screens (text or numeric inputs, selects, forms, buttons...).
...
* **import** has a method to import a whole file from an external <code class="language-text">.koda</code> archive.

* **export** has a method to export a whole file to an external <code class="language-text">.koda</code> archive.
