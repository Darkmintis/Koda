---
title: Common code
desc: Learn about architecture, data models, and development environments. See Koda's technical guide for developers. Dive into common code.
---

# Common code

In koda, we take advantage of using the same language in frontend and
...
* **pages** contains the definition of the [Koda data model](/technical-guide/developer/data-model/) and
...
* **file_builder** functions to parse the content of a <code class="language-text">.koda</code> exported file
...
* **uuid** functions to generate [Universally Unique Identifiers
  ...
  over all Koda models to have identifiers for objects that are practically
