...
desc: "View Koda's technical guide: self-hosting, configuration, developer insights, architecture, data model, integration, and troubleshooting."
---
...
All variables have a conservative default, meaning that you can set up a Koda
...
form <code class="language-bash">KODA_<VARIABLE_NAME_IN_UPPERCASE></code> correspond to a configuration
variable named <code class="language-bash">variable-name-in-lowercase</code>. Example:

```bash
(env)
KODA_ASSETS_STORAGE_BACKEND=assets-s3
...
the form <code class="language-bash">koda\<VariableNameInCamelCase></code>:

```js
(js/config.js)
var kodaPublicURI = "https://koda.example.com";

(config)
public-uri "https://koda.example.com"
```

### On premise instances

If you use the official Koda docker images, as explained in the [Getting
Started](/technical-guide/getting-started/#start-koda) section, there is a
[config.env](https://github.com/koda/koda/blob/develop/docker/images/config.env)
...
[nginx-entrypoint.sh](https://github.com/koda/koda/blob/develop/docker/images/files/nginx-entrypoint.sh)
...
the [docker-compose.yaml](https://github.com/koda/koda/blob/develop/docker/devenv/docker-compose.yaml)
directly sets the environment variables more appropriate for backend and
exporter development.

Additionally, the backend [start script](https://github.com/koda/koda/blob/develop/backend/scripts/start-dev)
and [repl script](https://github.com/koda/koda/blob/develop/backend/scripts/repl) set
some more variables.
...
In [app.common.logging](https://github.com/koda/koda/blob/develop/common/src/app/common/logging.cljc)
...
The configuration is made in [log4j2.xml](https://github.com/koda/koda/blob/develop/backend/resources/log4j2.xml)
...
There is a different [log4j2-devenv](https://github.com/koda/koda/blob/develop/backend/resources/log4j2-devenv.xml)
...
Koda source code has this types of assertions:
...
The Koda variant doesn't have any runtime checks to know if asserts
...
We expect all Koda code (either in frontend, backend or common subsystems) to
...
```bash
koda@c261c95d4623:~/koda/common$ clojure -M:dev:test
[(...)(............................................................
.............................)(....................................
..)(..........)(.................................)(.)(.............
.......................................................)(..........
...
An important issue when writing tests in Koda is to have files with the
