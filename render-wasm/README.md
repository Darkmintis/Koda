...
This is the canvas-based WebAssembly render engine for Koda.
...
We use Skia, an Open Source 2D graphics library. In particular, the render engine uses Skia via [custom binaries](https://github.com/koda/skia-binaries/releases/) of the [rust-skia crate](https://github.com/rust-skia/rust-skia).

## How to build

With the [Koda Development Environment](https://help.koda.app/technical-guide/developer/devenv/) running, create a new tab in the tmux.
