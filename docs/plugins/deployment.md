...
title: 3. Deployment
desc: Deploy your free Koda plugins! Learn about Netlify, Cloudflare, Surge & Koda submission in this guide. Build and share your creations.
---
...
domain: https://example-plugin-koda.surge.sh
...
Success! - Published to example-plugin-koda.surge.sh
```

5. Done!

## 3.5. Submitting to Koda

To make your finished plugin available in our catalog, submit in on the [plugin submission page](https://koda.app/kodahub/plugins/create-plugin). Once it becomes available any Koda user will be able to install and use it.
