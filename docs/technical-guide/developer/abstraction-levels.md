...
desc: "Koda Technical Guide: organize data and logic in clear abstraction layers—ADTs, file ops, event-sourced changes, business rules, and data events."
---

# Code organization in abstraction levels

Initially, Koda data model implementation was organized in a different way.
...
Currently most of Koda code does not follow those requirements, but it
...
This is the intersection of the logic and the presentation in Koda. Data
...
In current Koda code, there is some quantity of business logic in data events,
