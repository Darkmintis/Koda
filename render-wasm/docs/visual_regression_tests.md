...
Writing the tests is very similar to write any other test for Koda. However, some helpers have been added to address some issues specific to the new render engine.
