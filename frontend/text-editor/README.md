...
The editor can be built and updated inside Koda using the following command:

```sh
KODA_SOURCE_PATH=/path/to/koda/repository yarn build:update
```
...
This is compatible with the way Koda stores text content.
