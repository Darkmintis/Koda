...
desc: Learn about self-hosting, configuration, developer tools, data models, architecture, and integrations. View Koda's technical guide. Free to use!
---
...
[layers of our design](https://help.koda.app/user-guide/layer-basics), and it
corresponds with one SVG node, augmented with Koda special features.
...
If it's a SVG exported by Koda, it reads the metadata to reconstruct the
