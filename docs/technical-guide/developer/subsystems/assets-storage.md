...
desc: Learn about assets storage, API, object buckets, sharing, and garbage collection. See Koda's technical guide for developers. Try Koda - It's free.
---

# Assets storage

The [storage.clj](https://github.com/koda/koda/blob/develop/backend/src/app/storage.clj)
...
Stored objects are always served by Koda (even if they have a public URL,
...
(not related to AWS-S3 buckets, this is a Koda internal concept).
