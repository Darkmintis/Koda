...
desc: See the Koda plugin API changelog for version 1.0! Find breaking changes, deprecations, new features, and updated documentation. Try Koda for free.
---
...
[https://koda-plugins-api-doc.pages.dev/](https://koda-plugins-api-doc.pages.dev/)
- New samples repository with lots of samples to use the API:
[https://github.com/koda/koda-plugins-samples](https://github.com/koda/koda-plugins-samples)
...
- Changed types names to remove the Koda prefix. So for example: <code class="language-js">KodaShape</code> becomes <code class="language-js">Shape</code>; <code class="language-js">KodaFile</code> becomes <code class="language-js">File</code>, and so on. Check the [API documentation](https://koda-plugins-api-doc.pages.dev/) for more details.
- Changes on the <code class="language-js">koda.on</code> and <code class="language-js">koda.off</code> methods.
Previously you had to send the original callback to the off method in order to remove an event listener. Now, <code class="language-js">koda.on</code> will return an *id* that you can pass to the <code class="language-js">koda.off</code> method in order to remove the listener.

Previously:
```js
koda.on(‘pagechange’, myListener); // Register an event listener
koda.off(‘pagechange’, myListener); // Remove previously registered listener
```

Now:
```js
const id = koda.on(‘pagechange’, myListener);
koda.off(id);
```
...
- Change some names to better align with the names in Koda's UI.
  - type <code class="language-js">frame</code> is now <code class="language-js">board</code>:
    - <code class="language-js">KodaFrame</code> is now <code class="language-js">Board</code>
    - <code class="language-js">koda.createFrame</code> changed to <code class="language-js">koda.createBoard</code>
    ...
    - <code class="language-js">KodaFrameGuideX</code> now <code class="language-js">GuideX</code>
  - type<code class="language-js">rect</code> is <code class="language-js">rectangle</code>
    - <code class="language-js">KodaRectangle</code> is now <code class="language-js">Rectangle</code>
  - type<code class="language-js">circle</code> is<code class="language-js">ellipse</code>
    - <code class="language-js">KodaCircle</code> is now <code class="language-js">Ellipse</code>
    - <code class="language-js">koda.createCircle</code> changed to <code class="language-js">koda.createEllipse</code>
  - type<code class="language-js">bool</code> is<code class="language-js">boolean</code>
    - <code class="language-js">KodaBool</code> is now <code class="language-js">Boolean</code>
...
- Adds method koda.viewport.zoomToShapes to change the viewport to the shapes.
