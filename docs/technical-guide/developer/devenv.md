...
desc: Dive into Koda's development environment. Learn about self-hosting, configuration, developer tools, architecture, and more. See the Koda Technical Guide!
---
...
To start it, clone koda repository, and execute:
...
connect to koda by browsing to http://localhost:3449 .
...
with the koda application opened (otherwise, you will get the error
...
https://help.koda.app/technical-guide/developer/ui/#storybook
...
1. Create a new team or navigate to an existing team in Koda.
