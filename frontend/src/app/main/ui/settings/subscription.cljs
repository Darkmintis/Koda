...
(mf/defc subscription-page*
  ...
  (let [route          (mf/deref refs/route)
        ...
        (or (= params-subscription "subscription-to-koda-unlimited")
            (= params-subscription "subscription-to-koda-enterprise"))

        show-subscription-success-modal?
        (or (= params-subscription "subscribed-to-koda-unlimited")
            (= params-subscription "subscribed-to-koda-enterprise"))
      ...
      (when ^boolean authenticated?
        (cond
          ...
          (st/emit!
           ...
           (modal/show :management-dialog
                       {:subscription-type (if (= params-subscription "subscription-to-koda-unlimited")
                                             "unlimited"
                                             "enterprise")
          ...
          (st/emit!
           (modal/show :subscription-success
                       {:subscription-name (if (= params-subscription "subscribed-to-koda-unlimited")
     ...
     [:div {:class (stl/css :dashboard-content)}
      ...
      [:div {:class (stl/css :your-subscription)}
       ...
       [:div {:class (stl/css :membership-container)}
        ...
        [:div {:class (stl/css :membership)}
         [:> icon* {:class (stl/css :koda-member)
                    :icon-id "user"
                    :size "m"}]
         [:span {:class (stl/css :membership-date)}
