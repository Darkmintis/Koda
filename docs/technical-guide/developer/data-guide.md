...
desc: Learn about data structures, code organization, file operations, migrations, shape editing, and component syncing. See Koda's technical guide. Try it free!
---

# Data Guide

The data structures are one of the most complex and important parts of Koda.
...
Koda files must keep working without changes. If you follow the general
...
To export a koda file, basically we use the same system that is used to
...
children) and converts it into a Koda shape object. There are auxiliary
